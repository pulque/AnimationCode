...
import com.lizheblogs.android.animationcode.view.animation.item.RainItem;

/**
 * 实现分子，添加原子
 * Created by Norman.Li on 7/25/2016.
 */
public class RainScene extends Molecular {
    /**
     ...
     */
    public RainScene(int width, int height, int itemNum, int itemColor, boolean randColor) {
    ...
    protected void initScene() {
        for (int i = 0; i < itemNum; i++) {
            list.add(new RainItem(width, height, itemColor, randColor));
        }
    }
}
